	...
	<body >
		...
		<!-- Header -->
			<header id="header">
				...
				<nav id="nav">
					<ul>
						<li><a href="C2Q1_spec.php">Refreshtest</a></li>
...
<textarea name="answer1" rows="8" cols="45" placeholder="test"></textarea>
 ...
 <div id="canva"><iframe id="view"></iframe><div id="fixed" style="height: 100%;">  </div>
 <div id="test2"></div>

						<div id="test"></div>
 <form action="C2Q1_spec.php" method="post">
...
MathUtils.prototype.' . $_POST['answer'] . ' 

' . $_POST['answer'] . ' exports.MathUtils = function() {
   return MathUtils;
};
...
////////////////////////////////NODE.JS//////////////////////////////////////////					
   ...
   //    if (file_exists('reports/TEST-MathUtils.xml')) {
    // $myXML=simplexml_load_file('reports/TEST-MathUtils.xml'); 
...
//     echo $xml;
      echo $output1; 
       //$variable = $xml;
    //   $variable = $xml->testsuite[1]->testcase[4]->failure . "<br>";
    //$variable2 = $xml->testsuite[1]->testcase[6]->failure . "<br>";
       
       // $variable2 = $myXMLData->attributes[4]->Array->failure . "<br>";
  
//$variable = substr($variable, 0, strpos($variable, "at"));
    //  $variable2 = substr($variable2, 0, strpos($variable2, "at")); 
  //      echo $variable;
    //   echo $variable2;
      // echo $variable3;
       //echo $variable4;
  ...
  // $test=highlight_file('reports/TEST-MathUtils.xml',  $return = true );    
       
        // echo $test;
   //  echo $output1;
			//	   echo $output1;		
						//retrieve xml file
						//$monXml = fopen('reports/TEST-MathUtils.xml', 'a'); 
						// $ligne = fgets($monXml);
						// echo 'sdsdsdsd';
						...
						//$test=highlight_file('reports/$_POST['answer']-add.xml',  $return = true );
		...
		////////////               HINT SYSTEM             ////////////////////////////////////////////////////////////////////////////////////////////			
//switch (preg_match("#Exception#", $output1)) {
  //  case 0:
    //    echo "i equals 0";
      //  break;
    //case 1:
...
//}
						...
						if (preg_match("#Syntax#", $output1)) //It means that the answer is not a code
							{
											...
											echo '<script> var test1 = document.getElementById(\'test\');  
												...
												test1.innerHTML = \'<blockquote id="hint"> <strong>Correction and Hint: </strong> <br/>Please check the editor for syntax errors before compiling.<br/>Syntax error detected.</blockquote>\';
...
//special video YOUTUBE above
       ...
       elseif (preg_match("#property#", $output1)) 		
														{
												...
												test1.innerHTML = \'<blockquote id="hint"> <strong>Correction and Hint: </strong> <br/>You did not answer the question.<br/>Please add an answer.</blockquote>\';
												//test2.innerHTML = \'<blockquote> Your answer  cannot be compiled.<br/>It is not recognized as a code by the system. Try again.  </blockquote>\';
												test2.innerHTML= \' <iframe id=YTHint  height=100% width=50% src="https://www.youtube.com/embed/MeewPtL_R8o" frameborder="0" allowfullscreen></iframe>\'
							   ...
							   elseif (preg_match("#sum is not defined#", $output1)) 		
														{
												...
												test1.innerHTML = \'<blockquote id="hint"> <strong>Correction and Hint: </strong> <br/>Are your input paramters add1, add2 defined correctly<br/>function(add1, add2){return add1+add2;}; </blockquote>\';
												//test2.innerHTML = \'<blockquote> Your answer  cannot be compiled.<br/>It is not recognized as a code by the system. Try again.  </blockquote>\';
												test2.innerHTML= \' <iframe id=YTHint  height=100% width=50% src="https://www.youtube.com/embed/MeewPtL_R8o" frameborder="0" allowfullscreen></iframe>\'
       ...
       elseif (preg_match("#Contain#", $output1)) 		
														{
												...
												test1.innerHTML = \'<blockquote id="hint"> <strong>Correction and Hint: </strong> <br/>Try add = function(add1, add2) {return add1 + add2;};.<br/>Please add an answer.</blockquote>\';
												//test2.innerHTML = \'<blockquote> Your answer  cannot be compiled.<br/>It is not recognized as a code by the system. Try again.  </blockquote>\';
												test2.innerHTML= \' <iframe id=YTHint  height=100% width=50% src="https://www.youtube.com/embed/MeewPtL_R8o" frameborder="0" allowfullscreen></iframe>\'
						...
						else    // if it is not an exception (the answer is an actual code)
							{
									           ...
									           //XML REGEX
								if (preg_match("#failures=\"[1-99]\"#", $variable))             //Wrong answer
									{
												
												
												
												if (preg_match("#Error: Cannot find module#", $xml))  //specific hint
													{
												...
												elseif (preg_match("#to contain#", $xml)) 		
														{
												$variable = $xml->testsuite[1]->testcase[4]->failure . "<br>";
														echo '<script> var test1 = document.getElementById(\'test\');
															 var test2 = document.getElementById(\'test2\');  
												test1.innerHTML = <?php echo $variable?> \'<blockquote>Your answer is WRONG. <br/><strong> Hint : </strong>Remember to name function <i class="example">exports.add</i>.</blockquote>\';
...
editor.getSession().setUseWrapMode(true);  
   ...
   editor.getSession().on('change', function () {
    view.contents().find('body').html("<iframe src=" +
