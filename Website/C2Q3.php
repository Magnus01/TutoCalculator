			...
			<section id="main" class="wrapper">
				<div class="container">
					...
					<!-- Form -->
						...
						<div id="test"></div>
						<h3>Special Way of Defining a Function</h3>
						
						
						<p id="pp">Another way of defining an object having certain property types is the following (In the code to be executed “this” is a special object that makes the type unique to the specific car you are talking about.  It essentially binds property types to a certain variable, note the following examples:</p>
						<img src="images/function2.png" id="example"/><br/><br/>
						<p id="pp">This is called defining an object type. It has a very useful subtlety that is different from the previous example. Here one can create as many different kinds of cars and properties as one wants. Defining a new variable called mycar with different property values can now easily be done in this way by using “new”. This is a quick way of constructing a new object or many objects, with the same property type but different property values: </p>
						...
						<img src="images/function3.png" id="example" /><br/><img src="images/function4.png" id="example" /><br/><br/>
						<p id="pp">This is used for giving operators certain property values like unary and binary.</p>
	...
	<div class="container" >
        ...
        <div class="row">                                 
            <div class="form-group col-md-3">
					...
					<form action="C2Q3.php"  method="post">
			...
			<p><h3><strong>Question 3:</strong> Special Way of Defining a Function </h3> Create a contact object containing name, profession and the number of your contact. Give the contact a function to change it's number.
				</p>
							...
							<div class="row">                                 
								...
								<br/><br/><br/>
									<ul class="actions fit">
										...
										<li><a href="C2Q4.php" class="button  alt fit">Next question</a></li>
...
<?php           //////////////////////////////////////////////////////////PHP code//////////////////////////////////////////////////
   ...
   function Correction() {
					...
					$monfichier = fopen('Jasmine_Code/npm/node_modules/jasmine/bin/src/C2Q3.js', 'w+');  //Open the js file with permission to read and write
...
////////////////////////////////NODE.JS//////////////////////////////////////////					
						...
						$command1='  jasmine-node C2Q3_spec.js --junitreport';   //PHP doesn't seem to recognize it..
						...
						$test=highlight_file('reports/TEST-Chapter3Contact.xml',  $return = true );
						...
						if (preg_match("#TypeError|Exception#", $output1))
							{
											...
											echo '<script> var test1 = document.getElementById(\'test\');  
												...
												test2.innerHTML= \' <iframe width="854" height="480" src="https://www.youtube.com/embed/snQYmD4Kf7E" frameborder="0" allowfullscreen></iframe>\'
