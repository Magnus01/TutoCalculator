			...
			<section id="main" class="wrapper">
				<div class="container">
					...
					<!-- Form -->
				       ...
				       <h3>Precedence Operation</h3>
						
<p id="pp">The following function named MathSolver is used to define the infix to postfix operation in the following code, the method of defining precedence:</p>
                            
                            <img src="images/operators.png" id="example"/><br/><br/>
 <p id="pp">The important piece of this code is to understand is how the variables are defined specifically. You have the operator stack that gives the postfix expression. This is given in a string.  </p>
                            
 <p id="pp">You have the operator stack given in an array form [], this is necessary for imitating the functionality of a stack. As you need to compare the infix expression with the stack to see when operators should be placed in the “postfixstack”. </p>
                            
 <p id="pp"> You have the variable operator. This is given in curly brackets {}. This is a special way in JavaScript for defining a variable. This form is used to define multiple variables with the properties of the operators and the property value “4,3,2”. The variable being the operator, for example (*,+) and the property value the rank number. The exponent having the highest ranking because this operation is done first.</p>
	...
	<div class="container" >
        ...
        <div class="row">                                 
            <div class="form-group col-md-3">
					...
					<form action="C3Q2.php"  method="post">
			...
			<p><h3><strong>Question 2:</strong> Operator Ranking </h3>  Defining Precedence. Create a ranking system for operators “(^,*,/,+,-)”. Let the variable be called operators. Create the ranking system so the exponent has a value of 4, the multiplication value of 3, the division 2, the addition 1, and subtraction 0.
				</p>
							...
							<div class="row">                                 
								...
								<br/><br/><br/>
									<ul class="actions fit">
										...
										<li><a href="C3Q3.php" class="button  alt fit">Next question</a></li>
...
<?php           //////////////////////////////////////////////////////////PHP code//////////////////////////////////////////////////
   ...
   function Correction() {
					...
					$monfichier = fopen('Jasmine_Code/npm/node_modules/jasmine/bin/src/C3Q2.js', 'w+');  //Open the js file with permission to read and write
					...
					//echo '<p>Cette page a été vue ' .$_POST['prenom'] . ' fois !</p>';
						...
						fputs($monfichier, $_POST['answer'] . ' exports.StudentSolution = function() {
											return operators;
										};');    //post the answer
...
////////////////////////////////NODE.JS//////////////////////////////////////////					
						...
						$command1='  jasmine-node C3Q2spec.js --junitreport';   //PHP doesn't seem to recognize it..
						...
						$test=highlight_file('reports/TEST-precedence.xml',  $return = true );
						...
						if (preg_match("#TypeError|Exception#", $output1))
							{
											...
											echo '<script> var test1 = document.getElementById(\'test\');  
												...
												test2.innerHTML= \' <iframe width="854" height="480" src="https://www.youtube.com/embed/c4KjW98gc7M" frameborder="0" allowfullscreen></iframe>\'
