...
<div id="test">  <h3 id="test3"></h3><div id="test2"></div> <blockquote id="hint"> Your answer  cannot be compiled.<br/>It is not recognized as a code by the system. Try again.  </blockquote>
<iframe id="YTHint" src="https://www.youtube.com/embed/MeewPtL_R8o" frameborder="0" allowfullscreen></iframe>


<div id="fixed" style="height: 100%;"></div><form action="C2Q1magnus.php" method="post">
<input type="submit" value="Submit" id='submit'><a onclick="hide()" id="hide" class="button default">Hide</a></div>
...
editor.getSession().setUseWrapMode(true);
	...
	function hide() {
     var txt = document.getElementById('fixed');var submit = document.getElementById('submit');var hide = document.getElementById('hide');
	//alert("caca" + txt.offsetHeight + hide.style.bottom);
	...
	hide.style.bottom = '0';
    //alert(txt.style.height);
    
	} 
	else {
		txt.style.height = '100%';
		submit.style.bottom = '30%';
	hide.style.bottom = '30%';
	}
