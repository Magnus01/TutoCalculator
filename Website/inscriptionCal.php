...
<html lang="en" ng-app="CineFinder"> 
	...
	<body   ng-controller="ListingCTRL">
				...
				<div class="container">
					...
					<!-- Form -->
						<section>
							...
							<form method="post" action="inscriptionCal.php">
								<div class="row uniform 50%">
									...
									<div class="12u$">
										<ul class="actions">
											...
											<li><input href="Calculator.html" type="submit" class="button" name="submit" value="Confirm"></li>
		...
		function Validation()  {
		 ...
		 // if (!isset($_POST['password1']) OR !isset($_POST['password2']) OR $_POST['password1'] != $_POST['password2']) { echo '<script> alert("Veuillez retaper votre mot de passe.");</script>';}
		
		if (isset($_POST['name']) AND 
		isset($_POST['surname']) AND 

		isset($_POST['email']) AND 
		isset($_POST['conditions']) AND 
			...
			{      
				  ...
				  try
					...
					//$bdd->exec('INSERT INTO utilisateur(adresse_mail, mot_de_passe, nom, prénom) VALUES($_POST[\'email\'], $_POST[\'password1\'],$_POST[\'nom\'] ,$_POST[\'prenom\'])');
						...
						$req = $bdd->prepare('INSERT INTO user(email, level, surname,name) VALUES(:email, :level, :surname, :name)');
						$req->execute(array(
							'email' => $email,
							 'level' => $level,
							 'surname' => $surname,
		...
		echo '<script> alert("You have subscribed successfully ! Thanks a lot!"); location.href = "Calculator.html";</script>'; 
