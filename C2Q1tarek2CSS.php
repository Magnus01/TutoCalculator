	...
	<body >
		...
		<!-- Header -->
			<header id="header">
				...
				<nav id="nav">
					<ul>
						<li><a href="C2Q1tarek2CSS.php">Refreshtest</a></li>
		...
		#navPanel1 nav {
			...
			#navPanel1 nav ul {
				...
				#navPanel1 nav ul li {
					...
					#navPanel1 nav ul li:first-child a:not(.button), #navPanel nav ul li:first-child span:not(.button) {
						border-top: 0;
					}

					#navPanel1 nav ul li a:not(.button), #navPanel nav ul li span:not(.button) {
