	...
	<div class="container" >
        ...
        <div class="row">                                 
            <div class="form-group col-md-3">
					...
					<form action="C2Q2.php"  method="post">
			...
			<p><h3><strong>Question 2:</strong> Multiply function </h3> Create a function to compute the square of a number. Use this function to compute the squares of 1 to 10 and print it to the console.
				</p>
							...
							<div class="row">                                 
								...
								<br/><br/><br/>
									<ul class="actions fit">
										...
										<li><a href="C2Q3.php" class="button  alt fit">Next question</a></li>
...
<?php           //////////////////////////////////////////////////////////PHP code//////////////////////////////////////////////////
   ...
   function Correction() {
					...
					//echo '<p>Cette page a été vue ' .$_POST['prenom'] . ' fois !</p>';
						...
						fputs($monfichier, $_POST['answer'] . ' exports.multiply = function (multiplier1, multiplier2) {
										return multiply(multiplier1, multiplier2);
									};');    //post the answer
						...
						if (preg_match("#TypeError|Exception#", $output1))
								{
											...
											echo '<script> var test1 = document.getElementById(\'test\');  
												...
												test2.innerHTML= \' <iframe width="854" height="480" src="https://www.youtube.com/embed/AWdmI2qY3pc" frameborder="0" allowfullscreen></iframe>\'
										...
										if (preg_match("#failures=\"[1-99]\"#", $test))
											{
												...
												if (preg_match("#Error: Cannot find module#", $test))  //wrong answer
													{
														
														echo '<script> var test1 = document.getElementById(\'test\');
														var test2 = document.getElementById(\'test2\');  
														test1.innerHTML = \'<blockquote>Your answer is wrong. <br/><strong>Hint:</strong>   File name must be <i class="example">C2Q2.js</i>.</blockquote>\';
														test2.innerHTML = \'<blockquote>Your answer is wrong. <br/><strong>Hint:</strong> File name must be <i class="example">C2Q2.js</i>.</blockquote>\';
														//console.log(test1);
														</script>';
														
														}
														
												elseif (preg_match("#calculator.multiply is not a function#", $test)) 		
														{
														
														echo '<script> var test1 = document.getElementById(\'test\');
															var test2 = document.getElementById(\'test2\');  
														test1.innerHTML = \'<blockquote>Your answer is wrong. <br/><strong>Hint:</strong> Remember to name function <i class="example">exports.multiply</i>. </blockquote>\';
														test2.innerHTML = \'<blockquote>Your answer is wrong. <br/><strong>Hint:</strong> Remember to name function <i class="example">exports.multiply</i>. </blockquote>\';
														
														</script>';
														}
														
												elseif (preg_match("#expected [1-99] to be 6|expected [1-99] to be 15#", $test)) 		
														{
												...
												elseif (preg_match("#expected undefined to be 5|expected undefined to be 8#", $test)) 		
														{
											...
											else
											{
												...
												echo '<script> var test1 = document.getElementById(\'test\');
														 var test2 = document.getElementById(\'test2\');  
														test.innerHTML = \'<blockquote>Congratulation! Your answer is correct.</blockquote>\';
														//console.log(test1);
														</script>';
											}
							}
