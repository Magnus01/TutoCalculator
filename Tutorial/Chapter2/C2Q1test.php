...
<textarea name="answer1" rows="8" cols="45" placeholder="test"></textarea>
 ...
 <div id="canva"><div id="fixed" style="height: 100%;">Your answer here.</div>
 <div id="test2"></div>

						<div id="test"></div>
 <form action="C2Q1tarek.php" method="post">
 
 <textarea name="answer" rows="8" cols="45" placeholder="Your answer here."></textarea>
 
<input name="submit1" type="submit" value="Submit" id='submit1'><a onclick="hide()" id="hide" class="button default">Hide</a></div>
						...
						if (preg_match("#TypeError|Exception#", $output1)) //It means that the answer is not a code
							{
											...
											echo '<script> var test1 = document.getElementById(\'test\');  
												...
												test1.innerHTML = \'<blockquote id="hint"> Your answer  cannot be compiled.<br/>It is not recognized as a code by the system. Please View Video Hint below.</blockquote>\';
...
editor.getSession().setUseWrapMode(true);
    ...
    //alert(txt.style.height);
		...
		hint1.show();
		txt.style.height = '100%';yt.style.height = '100%';
