...
<!-- 25/08/09 text-editor, menu, download and save system  

Problem : the hints aren't displayed (the cohabitation between the two systems is problematic)
 -->
	...
	<body >
		...
		<!-- Header -->
			<header id="header">
				...
				<nav id="nav">
					<ul>
						<li><a href="C2Q1tarek2IFRAMECSSsave.php">Refreshtest</a></li>
...
<textarea name="answer1" rows="8" cols="45" placeholder="test"></textarea>
 ...
 <div id="canva"><iframe id="view"></iframe><div id="fixed" style="height: 100%;"><div id="editorContent">&lt;script type="text/javascript"&gt;     
 ...
 <div id="test2"></div>
						...
						<div id="test"></div>
 <form action="C2Q1tarek2IFRAMECSSsave.php" method="post">
...
<a onclick="hide()" id="hide" class="button default">Hide</a><a onclick="menu()" id="menu" class="button default">Menu</a></div>
...
<form action="C2Q1tarek2IFRAMECSSsave.php" method="post">
  <textarea name="saveText" rows="8" cols="45" ></textarea>
<input name="save" type="submit" value="Save" id='save'></form>
...
<h1>Chapter 1:</h1>
					<ul>
						<li><a href="C2Q1tarek2IFRAME.php">C1Q1</a></li>
						<li><a href="Calculator.html">C1Q2</a></li>
						<li><a href="inscriptionCal.php">C1Q3</a></li>
						<li><a href="inscriptionCal.php">C1Q4</a></li>
						
					</ul>-->
					<h1>Chapter 2:</h1>
					<ul>
						<li><a href="C2Q1tarek2IFRAME.php">C2Q1</a></li>
						<li><a href="Calculator.html">C2Q2</a></li>
						<li><a href="inscriptionCal.php">C2Q3</a></li>
						<li><a href="inscriptionCal.php">C2Q4</a></li>
						
					</ul> <h1>Chapter 3:</h1>
					<ul>
						<li><a href="C2Q1tarek2IFRAME.php">C3Q1</a></li>
						<li><a href="Calculator.html">C3Q2</a></li>
						<li><a href="inscriptionCal.php">C3Q3</a></li>
						<li><a href="inscriptionCal.php">C3Q4</a></li>
						
					</ul> <h1>Chapter 4:</h1>
					<ul>
						<li><a href="C2Q1tarek2IFRAME.php">C4Q1</a></li>
						<li><a href="Calculator.html">C4Q2</a></li>
						<li><a href="inscriptionCal.php">C4Q3</a></li>
						<li><a href="inscriptionCal.php">C4Q4</a></li>
...
<?php           //////////////////////////////////////////////////////////PHP code//////////////////////////////////////////////////
 ...
 &lt;/script&gt;
					*/
					...
					if(isset($_SESSION['content']))
					{
						...
						echo '<script> var save = document.getElementById(\'editorContent\');
														alert("content")	;	
														save.innerHTML = \'' . $_SESSION['content'] .  '\';
					...
					// else {
						// echo '<script> var test1 = document.getElementById(\'editorContent\');
																// alert(\'javascript\')	;	
														// test1.innerHTML = \' &lt;script type="text/javascript"&gt;     
 ...
 // &lt;/script&gt;  \';
   ...
   function Save() {
	   ...
	   $_SESSION['content']=$_POST['saveText'];
	   echo $_SESSION['content'];
...
// });
  ...
  $('#download').on('click', function() {
	...
	//For save
	 ...
	 var textarea2 = $('textarea[name="saveText"]'); //textarea1.hide();
    //textarea1.hide();
