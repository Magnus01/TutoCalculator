			...
			<section id="main" class="wrapper">
				<div class="container">
					...
					<!-- Form -->
						...
						<h3>Simplified infix to postfix conversion- One that only accepts numbers</h3>
						<p>This question will include the isNumeric(x) function and the for loop that was taught previously:</p>
                            
                           <img src="../../images/isNumeric.png" id="example"/><br/><br/>
                            
 <p id="pp">For Loop:  </p>
                            
                            <img src="../../images/for.png" id="example"/><br/><br/>
                            
 <p id="pp">We want to collect our transformed infix expression into an empty array. Let’s call this: </p>
                         
                            <img src="../../images/newarray.png" id="example"/><br/><br/>
                            
 <p id="pp"> Remember, a stack has two properties, a length and an index. The length of the stack is defined to be the number of items in the stack. The index of the stack is the position that each item in the stack has where the first item of the stack has position zero (1, 2, 3) has index (0,1,2). 
</p>
				
                            <img src="../../images/forMathSolver.png" id="example"/><br/><br/>
                            
<p id="pp">Here the infix expression (eg, 2*3), is going to be looped in the “for loop” through the index infix[i], in order to check to see if it is indeed a number or not. Every infix index will be given the variable name token throughout each iteration.</p>
                            
<p id="pp">Now, notice below how the code will develop. All the things learned up until now are used together like a nice cooking recipe:</p>
                            <img src="../../images/MathSolver.png" id="example"/><br/><br/>
                            
 <p id="pp">The whole function will be called MathSolver (using the same for loop as was seen above).</p>
 <p id="pp">The main job of MathSolver, is to check every token to see if it is numeric. If this is true, then it is sent to the postfix stack.</p>
 <p id="pp">How is it sent to the postfix stack?</p>
 <p id="pp">To answer this, we are going to use the push() and pop() expressions.</p>
<p id="pp">The push() method adds new items to the end of an array.</p>

 <img src="../../images/pushpop.png" id="example"/><br/><br/>

<p id="pp">While the push adds an element, the pop() method simply removes the last element of an array, and returns that element. Remember, these actions change the length of the array. This is why it is used in the calculator, as one can now calculate in a step by step method by using stacks (which is what the computer does efficiently and is why this is done).</p>
						<div id="test"></div>
	...
	<div class="container" >
        ...
        <div class="row">                                 
            <div class="form-group col-md-3">
					...
					<form action="C3Q3.php"  method="post">
			...
			<p><h3><strong>Question 3:</strong> Simplified infix to postfix </h3> Create a function called infix. Create a stack using an array, called postfixstack. Now using the “isNumeric” function that you created in question 1, create a simplified infix to postfix conversion. One that only accepts numbers.
Create a for loop that will go through the index of every number in the infix expression. If what is contained inside the index is a number push it to the postfix expression i.e. postfixstack.
                        Use the infix expression to complete the test: "4", "+", "5", "*", "2"
				</p>
							...
							<div class="row">                                 
								...
								<br/><br/><br/>
									<ul class="actions fit">
										...
										<li><a href="C3Q4.php" class="button  alt fit">Next question</a></li>
...
<?php           //////////////////////////////////////////////////////////PHP code//////////////////////////////////////////////////
   ...
   function Correction() {
					...
					$monfichier = fopen('Jasmine_Code/npm/node_modules/jasmine/bin/src/C3Q3.js', 'w+');  //Open the js file with permission to read and write
					...
					//echo '<p>Cette page a été vue ' .$_POST['prenom'] . ' fois !</p>';
						...
						fputs($monfichier, $_POST['answer'] . ' exports.MathSolver = function (infix){
...
////////////////////////////////NODE.JS//////////////////////////////////////////					
						...
						$command1='  jasmine-node C3Q3spec.js --junitreport';   //PHP doesn't seem to recognize it..
						...
						if (preg_match("#TypeError|Exception#", $output1))
							{
											...
											echo '<script> var test1 = document.getElementById(\'test\');  
												...
												test2.innerHTML= \' <iframe width="854" height="480" src="https://www.youtube.com/embed/PK52g-UCweM" frameborder="0" allowfullscreen></iframe>\'
